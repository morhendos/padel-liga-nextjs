    ...
    <>
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead>
            <tr>
              <th className="bg-[#7A735B] text-white p-3 text-left rounded-tl-lg">#</th>
              <th className="bg-[#7A735B] text-white p-3 text-left">Player</th>
              <th className="bg-[#7A735B] text-white p-3 text-left hidden md:table-cell">Form</th>
              ...
              <th className="bg-[#7A735B] text-white p-3 text-left rounded-tr-lg">Points</th>
            </tr>
          </thead>
          <tbody>
            {players.map((player) => (
              <tr 
                ...
                className={`
                  transition-colors
                  ${player.rank === 1 ? 'bg-[#7A735B]/10 font-bold' :
                    player.rank === 2 ? 'bg-[#9A9283]/10' :
                    player.rank === 3 ? 'bg-[#7A735B]/5' : ''}
                `}
              >
                <td className="p-3 border-b">{player.rank}</td>
                <td className="p-3 border-b">
                  <div className="flex items-center">
                    <span className="text-[#7A735B] font-medium">{player.name}</span>
    ...
    return (
      <div className="space-y-4">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-lg font-semibold text-[#7A735B]">Latest Matches</h3>
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <div className="flex-1">
                  <div className="font-medium text-[#7A735B]">{match.player1}</div>
                  <div className="font-medium text-[#7A735B]">{match.player2}</div>
                </div>
